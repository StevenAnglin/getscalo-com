      ...
      <div className="relative w-full max-w-sm text-center">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 h-12 rounded-xl bg-[var(--scalo-ember)] hover:bg-[var(--scalo-ember)]/90 text-[var(--scalo-bg-0)] text-sm font-medium transition-colors btn-press disabled:opacity-40 disabled:pointer-events-none shadow-[0_0_32px_rgba(170,255,0,0.25)]"
          >
