      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          ...
          {pillars.map((p, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-xl font-medium text-[var(--scalo-ink)] mb-3">{p.name}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-[var(--scalo-border-ghost)]">
            {steps.map((s) => (
              <div key={s.n} className="p-8 relative overflow-hidden group">
                ...
                <div className="absolute -top-2 right-4 tnum text-[96px] font-medium leading-none text-[var(--scalo-ink)]/[0.04] select-none pointer-events-none group-hover:text-[var(--scalo-ember)]/[0.06] transition-colors duration-300">
                  {s.n}
                </div>
                ...
                <h4 className="text-lg font-medium text-[var(--scalo-ink)] mb-2">{s.title}</h4>
        ...
        <div className="grid grid-cols-3 gap-6 mt-12 max-w-[560px]" data-reveal data-delay="300">
          ...
          <div className="border-l-2 border-[var(--scalo-border-strong)] pl-4">
            <div className="tnum text-3xl font-medium text-[var(--scalo-ink)]">$50K+</div>
            <div className="text-[11px] uppercase tracking-widest text-[var(--scalo-fg-3)] mt-1.5">Rev minimum</div>
          </div>
          <div className="border-l-2 border-[var(--scalo-border-strong)] pl-4">
            <div className="tnum text-3xl font-medium text-[var(--scalo-ink)]">4–8</div>
