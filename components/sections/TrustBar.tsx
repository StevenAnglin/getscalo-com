...
export default function TrustBar() {
  return (
    <section
      id="trust"
      className="relative bg-[var(--scalo-bg-1)] py-5 border-y border-[var(--scalo-border-hairline)] overflow-hidden"
    >
      <div className="flex items-center">
        {/* Label */}
        <div className="shrink-0 pl-6 lg:pl-12 pr-6 border-r border-[var(--scalo-border-hairline)] z-10">
          <span className="text-[10px] uppercase tracking-widest text-[var(--scalo-fg-3)] whitespace-nowrap">
            Trusted by
        ...
        <div className="flex-1 overflow-hidden relative">
          {/* Left fade */}
          <div className="absolute left-0 top-0 bottom-0 w-12 bg-gradient-to-r from-[var(--scalo-bg-1)] to-transparent z-10 pointer-events-none" />
          {/* Right fade */}
          <div className="absolute right-0 top-0 bottom-0 w-20 bg-gradient-to-l from-[var(--scalo-bg-1)] to-transparent z-10 pointer-events-none" />
