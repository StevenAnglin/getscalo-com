export default function Footer() {
  return (
    <footer className="relative border-t border-[var(--scalo-border-hairline)] py-16 lg:py-20">
      ...
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[var(--scalo-ember)]/30 to-transparent" />

      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-12">
          {/* Wordmark + tagline */}
          <div className="col-span-2 lg:col-span-5">
            <div className="text-2xl font-medium text-[var(--scalo-cream)] tracking-tight">scalo.</div>
            <p className="text-[11px] uppercase tracking-widest text-[var(--scalo-fg-3)] mt-3">
              Website Optimization Agency
            </p>
            <p className="text-sm text-[var(--scalo-fg-2)] mt-5 max-w-[300px] leading-relaxed">
              Working exclusively with Shopify brands doing $50K&ndash;$1M+/month. We find leaking revenue and fix it.
            </p>
            <div className="flex items-center gap-2 mt-6">
              <div className="w-1.5 h-1.5 rounded-full bg-[var(--scalo-ember)] pulse-dot" />
              <span className="text-xs text-[var(--scalo-fg-3)] tracking-wide">Accepting new clients</span>
            </div>
          </div>
          ...
          <div className="col-span-2 lg:col-span-3">
            ...
            <div className="flex gap-3 mt-6">
              <a href="#" aria-label="LinkedIn" className="w-9 h-9 rounded-full border border-[var(--scalo-border-ghost)] hover:border-[var(--scalo-cream)] flex items-center justify-center text-[var(--scalo-fg-2)] hover:text-[var(--scalo-cream)] transition-colors">
              ...
              <a href="#" aria-label="X (Twitter)" className="w-9 h-9 rounded-full border border-[var(--scalo-border-ghost)] hover:border-[var(--scalo-cream)] flex items-center justify-center text-[var(--scalo-fg-2)] hover:text-[var(--scalo-cream)] transition-colors">
        ...
        {/* Bottom bar */}
        <div className="pt-8 border-t border-[var(--scalo-border-hairline)] flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 text-xs text-[var(--scalo-fg-3)]">
          <span>© 2026 Scalo. All rights reserved.</span>
          <div className="flex items-center gap-6">
            <a href="mailto:steven@getscalo.com" className="hover:text-[var(--scalo-fg-2)] transition-colors">
              steven@getscalo.com
            </a>
          </div>
        </div>
