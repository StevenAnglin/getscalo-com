      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] rounded-3xl overflow-hidden border border-[var(--scalo-border-ghost)]" data-reveal data-delay="100">
          ...
          <div className="p-10 lg:p-14 bg-[var(--scalo-bg-2)] relative overflow-hidden border-b lg:border-b-0 lg:border-r border-[var(--scalo-border-ghost)]">
            ...
            <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium tracking-widest uppercase border border-[var(--scalo-border-strong)] text-[var(--scalo-ink)]">
              {audit.tag}
            </div>
            <h3 className="text-3xl lg:text-4xl font-medium text-[var(--scalo-ink)] mt-6 tracking-tight">
              {audit.headline}
            </h3>
              ...
              {audit.features.map((f) => (
                <li key={f} className="flex items-center gap-3 text-sm text-[var(--scalo-fg-2)]">
                  <div className="w-5 h-5 rounded-full bg-[var(--scalo-bg-3)] border border-[var(--scalo-border-ghost)] flex items-center justify-center shrink-0">
                    <Check className="w-3 h-3 text-[var(--scalo-ink)]" strokeWidth={2.5} />
                  </div>
                  {f}
                </li>
              ))}
            ...
            <a
              href="#book"
              className="mt-10 inline-flex items-center gap-1.5 bg-[var(--scalo-cream)] hover:bg-[var(--scalo-cream)]/90 text-[var(--scalo-ink)] rounded-full h-12 px-7 text-sm font-medium transition-colors btn-press"
            >
          ...
          <div className="p-10 lg:p-14 bg-[var(--scalo-bg-1)] relative overflow-hidden">
            ...
            <div className="pointer-events-none absolute -bottom-16 -right-16 w-64 h-64"
              style={{ background: "radial-gradient(circle at 70% 70%, rgba(170,255,0,0.14) 0%, transparent 70%)" }} />

            <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium tracking-widest uppercase bg-[var(--scalo-ember)] text-[var(--scalo-ink)]">
              {program.tag}
            </div>
            <h3 className="text-3xl lg:text-4xl font-medium text-[var(--scalo-ink)] mt-6 tracking-tight">
              {program.headline}
