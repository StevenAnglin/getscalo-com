...
export default function FinalCTA() {
  return (
    ...
    >
      {/* Volt green centered glow on dark bg */}
      ...
      <div className="relative max-w-[1440px] mx-auto px-6 lg:px-12 text-center" data-reveal>
        ...
        <div className="inline-flex items-center gap-2 mb-10">
          <div className="h-px w-8 bg-[var(--scalo-accent)]/50" />
          <span className="text-[11px] uppercase tracking-widest text-[var(--scalo-accent)] font-medium">
        ...
        <h2 className="display-xl text-[var(--scalo-cream)] max-w-[1100px] mx-auto tracking-tight">
          ...
          <span className="italic-editorial text-[var(--scalo-accent)]">We find it in 48 hours.</span>
        </h2>

        <p className="body-lg text-[var(--scalo-cream)]/60 mt-10 max-w-[560px] mx-auto">
        ...
        <a
          ...
          className="mt-12 inline-flex items-center gap-2 bg-[var(--scalo-accent)] hover:bg-[var(--scalo-accent-dim)] text-[var(--scalo-ink)] rounded-full h-14 px-8 text-base font-semibold transition-colors btn-press shadow-[0_0_40px_rgba(170,255,0,0.30)]"
        >
          Book a free teardown call <ArrowUpRight className="w-5 h-5" />
        </a>

        <p className="text-xs text-[var(--scalo-cream)]/30 mt-8 tracking-wide">
